...
const CACHE = 'forge-7a93fa6c23d8';
const FONT_CACHE = 'forge-fonts';
const FONT_HOSTS = ['fonts.googleapis.com', 'fonts.gstatic.com'];
const BASE = new URL(self.registration.scope).pathname;
const PRECACHE = ["_expo/static/js/web/AppEntry-dd5624c5077244ec141af1a2db864bf3.js","apple-touch-icon.png","fonts/inter.woff2","fonts/jetbrains-mono.woff2","icon-192.png","icon-512.png","index.html","manifest.json","metadata.json","vbt/assets/index-DRd-G7h3.js","vbt/assets/index-dql96tdh.css","vbt/icons/apple-touch-icon.png","vbt/icons/icon-192.png","vbt/icons/icon-512.png","vbt/index.html"].map((p) => BASE + p);
