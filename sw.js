...
const CACHE = 'forge-1c3026071320';
const FONT_CACHE = 'forge-fonts';
const FONT_HOSTS = ['fonts.googleapis.com', 'fonts.gstatic.com'];
const BASE = new URL(self.registration.scope).pathname;
const PRECACHE = ["_expo/static/js/web/AppEntry-cba2efb97da401edc294e19f799830cb.js","apple-touch-icon.png","fonts/inter.woff2","fonts/jetbrains-mono.woff2","icon-192.png","icon-512.png","index.html","manifest.json","metadata.json","vbt/assets/index-BJb3dNtN.css","vbt/assets/index-DQqdBBxe.js","vbt/icons/apple-touch-icon.png","vbt/icons/icon-192.png","vbt/icons/icon-512.png","vbt/index.html"].map((p) => BASE + p);
